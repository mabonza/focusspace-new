...
async function seedIfEmpty(strapi) {
  try {
    ...
    const eventsData = [
      { title: 'International Conference on Health Systems Research 2025', slug: 'ichs-2025-main', type: 'conference', status: 'upcoming', shortDescription: 'Three days of evidence-based dialogue on universal health coverage, health financing, and service delivery innovations.', description: 'Join over 800 delegates from 40+ countries at the premier health systems research conference in Africa.', startDate: '2025-09-15T08:00:00', endDate: '2025-09-18T17:00:00', location: 'Johannesburg, South Africa', venue: 'Sandton Convention Centre', registrationUrl: '#register', conference: ichs2025.id },
      { title: 'Pre-Conference Workshop: Health Economics Masterclass', slug: 'hec-workshop-2025', type: 'workshop', status: 'upcoming', shortDescription: 'An intensive one-day masterclass covering cost-effectiveness analysis and budget impact modelling.', startDate: '2025-09-14T09:00:00', endDate: '2025-09-14T17:00:00', location: 'Johannesburg, South Africa', venue: 'Sandton Convention Centre – Workshop Hall B', registrationUrl: '#register', conference: ichs2025.id },
      { title: 'Webinar: Emerging Infectious Diseases in Resource-Limited Settings', slug: 'webinar-eid-2025', type: 'webinar', status: 'upcoming', shortDescription: 'A virtual panel discussion on surveillance, response readiness, and community engagement.', startDate: '2025-07-22T14:00:00', endDate: '2025-07-22T16:00:00', location: 'Virtual', venue: 'Zoom', registrationUrl: '#register', conference: ichs2025.id },
      { title: 'African Public Health Summit 2024', slug: 'aphs-2024-main', type: 'summit', status: 'past', shortDescription: 'A landmark summit on community-centred disease prevention across Sub-Saharan Africa.', startDate: '2024-06-10', endDate: '2024-06-12', location: 'Nairobi, Kenya', venue: 'Kenyatta International Convention Centre', conference: aphs2024.id },
      { title: 'Digital Health Innovation Forum 2024', slug: 'dhif-2024-main', type: 'conference', status: 'past', shortDescription: 'Exploring digital tools, AI, and telemedicine in transforming African healthcare.', startDate: '2024-03-05', endDate: '2024-03-07', location: 'Cape Town, South Africa', venue: 'Cape Town International Convention Centre', conference: dhif2024.id },
      { title: 'Global Maternal & Child Health Conference 2023', slug: 'gmch-2023', type: 'conference', status: 'past', shortDescription: 'Evidence-driven strategies to reduce maternal and neonatal mortality across Africa.', startDate: '2023-10-18', endDate: '2023-10-20', location: 'Accra, Ghana', venue: 'Accra International Conference Centre' },
    ]
