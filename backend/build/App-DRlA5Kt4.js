...
`,Xn=({asset:e})=>{const{alternativeText:n,ext:r,formats:o,mime:s,url:a}=e;if(s?.includes(k.Image)){const l=ee(o?.thumbnail?.url)??ee(a);if(l)return t.jsx(De,{children:t.jsx(Yn,{src:l,alt:n||""})})}const i=q(s,r);return t.jsx(De,{children:t.jsx(Jn,{justifyContent:"center",alignItems:"center",children:t.jsx(i,{width:48,height:48})})})},er=h(It)`
