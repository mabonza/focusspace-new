...
export const dummyPastEvents: Event[] = [
  {
    ...
    type: 'summit',
    status: 'past',
    shortDescription: 'A landmark summit on community-centred disease prevention across Sub-Saharan Africa.',
    description:
      'Over 600 delegates gathered in Nairobi to share community health innovations, policy lessons, and research findings from across the continent.',
    startDate: '2024-06-10',
    endDate: '2024-06-12',
    location: 'Nairobi, Kenya',
    venue: 'Kenyatta International Convention Centre',
  },
  {
    ...
    type: 'conference',
    status: 'past',
    shortDescription: 'Exploring the role of digital tools, AI, and telemedicine in transforming African healthcare.',
    description:
  ...
  {
    id: 12,
    title: 'Global Maternal & Child Health Conference 2023',
    slug: 'gmch-2023',
    type: 'conference',
    status: 'past',
    shortDescription: 'Evidence-driven strategies to reduce maternal and neonatal mortality across Africa.',
    description:
      'A multi-disciplinary conference uniting obstetricians, midwives, researchers, and community health workers in the pursuit of safer births.',
